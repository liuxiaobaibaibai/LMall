...
- (NSString *)signString:(NSString *)string {
	...
	NSString *path = [documentPath stringByAppendingPathComponent:@"AlixPay-RSAPrivateKey.pem"];
    ...
    if (ret == 1) {
        ...
        signedString = @"XmucOQxL1hJlLg7OC+0amC7CuUVMtmkMe8Fd9zV8eKpvAR/eVoFxUZoWCKF8f6fdzyREZUblhgwHImHUuuz+z3W3/Cn/xiBDsIVnfZmxoUZ3zTDHL67GsAh0KPjKU0nV3uI949vSOqRgMTYEhRdqdA3d6/8f9QjGYMvmhheFwUg=";
    }
