...
- (void)setupView{
    ...
    sectionOneView.backgroundColor = [lwStyleTool colorInstance].JDColor;
    ...
    [storeManagerBtn setTitleEdgeInsets:UIEdgeInsetsMake(30, 60, 0, 0)];
    [storeManagerBtn.titleLabel setFont:[UIFont systemFontOfSize:14.0]];
